...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `AwsSigv4.swiftmodule/`
...
//      `import AwsSigv4` above would fail at compile time.
//
//   2. The static archive `libAwsSigv4.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "AwsSigv4" }` and
//      `flattenPackage = "io.github.kotlinmania.awssigv4"` configuration in
...
//      via the `AwsSigv4Library` product.
//
