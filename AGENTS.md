...
This file is the quick-reference operating contract for aws-sigv4-kotlin. The longer
...
aws-sigv4-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`aws-sigv4`](https://crates.io/crates/aws-sigv4). Upstream Rust is the behavioral oracle while the
