...
kotlin {
    ...
    val xcf = XCFramework("AwsSigv4")

    macosArm64 {
        binaries.framework { baseName = "AwsSigv4"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "AwsSigv4"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "AwsSigv4"
        flattenPackage = "io.github.kotlinmania.awssigv4"
    }

    android {
        namespace = "io.github.kotlinmania.awssigv4"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "aws-sigv4-kotlin", version.toString())

    pom {
        name.set("aws-sigv4-kotlin")
        description.set("Kotlin Multiplatform port of smithy-lang/smithy-rs - SigV4 signer for HTTP requests and Event Stream messages")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/aws-sigv4-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/aws-sigv4-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/aws-sigv4-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/aws-sigv4-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            val sentinelFile = sentinelDir.get().asFile.resolve(
                "io/github/kotlinmania/awssigv4/CodeqlEmptySentinel.kt",
            )
